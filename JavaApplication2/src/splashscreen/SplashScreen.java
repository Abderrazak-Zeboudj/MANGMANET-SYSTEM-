...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\soulaimane\\Downloads\\sliman.jpg")); // NOI18N

        lbStatus.setFont(new java.awt.Font("Perpetua Titling MT", 0, 24)); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    doTask("Connect To Database ...", 10);
                     try {
            File songFile = new File("C:\\Users\\soulaimane\\Desktop\\DispalyBAhai\\JavaApplication2\\src\\son\\scard (1).wav"); // Replace with the actual path to your song file
            ...
            clip.stop();
                    ...
                    doTask("telechargement  .....", 30);
                    doTask("telechargement  .....", 70);
                    doTask("telechargement  .....", 90);
                    doTask("telechargement  .....", 100);
                    doTask("welcome to display bahai", 100);
                    doTask("welcome to display bahai", 100);
//                    doTask("welcome to display bahai", 100);
                    dispose();
