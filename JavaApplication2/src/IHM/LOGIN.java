...
public class LOGIN extends javax.swing.JFrame {
  ...
  void icon(){
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_cancel_48px.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_Checkmark_48px_2.png"))); // NOI18N
        ...
        user.setBackground(new java.awt.Color(17, 114, 169));
        user.setForeground(new java.awt.Color(255, 255, 255));
        user.setFont(new java.awt.Font("Perpetua Titling MT", 1, 18)); // NOI18N
        user.setLabeText("");
        user.setLineColor(new java.awt.Color(51, 153, 255));
        ...
        jLabel4.setText("Type d'Utilisteur : ");

        type.setBackground(new java.awt.Color(17, 114, 169));
        type.setForeground(new java.awt.Color(255, 255, 255));
        type.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Admin", "Employe" }));
        type.setFont(new java.awt.Font("Perpetua Titling MT", 1, 18)); // NOI18N
        type.setLabeText("");
        type.setLineColor(new java.awt.Color(51, 153, 255));
        ...
        passwordField1.setBackground(new java.awt.Color(17, 114, 169));
        ...
        passwordField1.setFont(new java.awt.Font("Palatino Linotype", 0, 20)); // NOI18N
        passwordField1.setLabelText("Password");
        passwordField1.setLineColor(new java.awt.Color(51, 153, 255));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(passwordField1, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\soulaimane\\Desktop\\icon\\login6.jpg")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{     
      if(  db.FindUser((String)type.getSelectedItem(),(String) user.getSelectedItem(), passwordField1.getText())==1)
    {
        String t =(String)type.getSelectedItem();
      if(t.equals("Admin")){
        Home ab =new Home();
        ab.setVisible(true);
        String nom= (String) user.getSelectedItem();
        System.out.println("IHM.LOGIN.jButton2ActionPerformed()");
         passwordField1.setText("");
         try {
            File songFile = new File("C:\\Users\\soulaimane\\Desktop\\DispalyBAhai\\JavaApplication2\\src\\son\\admin.wav"); // Replace with the actual path to your song file
...
//            JOptionPane.showMessageDialog(this, "Song is playing. Click OK to stop.");
            ...
            Home ab =new Home();
            ab.setVisible(true);
                ab.jButton1.setEnabled(false);
              passwordField1.setText("");
                try {
            File songFile = new File("C:\\Users\\soulaimane\\Desktop\\DispalyBAhai\\JavaApplication2\\src\\son\\empolyer.wav"); // Replace with the actual path to your song file
...
//       try {
//            File songFile = new File("C:\\Users\\soulaimane\\Desktop\\DispalyBAhai\\JavaApplication2\\src\\son\\Untitled Project.wav"); // Replace with the actual path to your song file
//
//            Clip clip = AudioSystem.getClip();
//            clip.open(AudioSystem.getAudioInputStream(songFile));
//            clip.start();
...
//        }
     this.setState(JFrame.ICONIFIED);    
      ...
      {
          System.out.println("IHM.LOGIN.jButton2ActionPerformed() 2");
      ERREUR dialog = new ERREUR(new javax.swing.JFrame(), true);
           ...
           System.out.println("IHM.LOGIN.jButton2ActionPerformed()3");
...
//        db.FindNomusr(user) ;
      ...
      try {
            File songFile = new File("C:\\Users\\soulaimane\\Desktop\\DispalyBAhai\\JavaApplication2\\src\\son\\login.wav"); // Replace with the actual path to your song file
...
setState(JFrame.ICONIFIED);        // TODO add your handling code here:
 ...
 db =new ConnectDB();
    ...
    private combobox.Combobox user;
