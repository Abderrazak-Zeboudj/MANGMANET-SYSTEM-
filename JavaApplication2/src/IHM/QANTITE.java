 ...
 * @author Abderrazak
 */
public class QANTITE extends javax.swing.JDialog {
     ...
     */
    public QANTITE(java.awt.Frame parent, boolean modal) {
...
this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("VERIFIEZ LE Métrage SVP");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/erreurm.png"))); // NOI18N
...
try {
            File songFile = new File("C:\\Users\\soulaimane\\Desktop\\DispalyBAhai\\JavaApplication2\\src\\son\\VERIFIEZ LE QUANTITE SVP.wav"); // Replace with the actual path to your song file
...
//            JOptionPane.showMessageDialog(this, "Song is playing. Click OK to stop.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QANTITE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
