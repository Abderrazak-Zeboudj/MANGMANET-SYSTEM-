 ...
 * @author Abderrazak
 */
public class erouruser extends javax.swing.JDialog {
     ...
     */
    public erouruser(java.awt.Frame parent, boolean modal) {
...
this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("le user existe déjà");
...
try {
            File songFile = new File("C:\\Users\\soulaimane\\Desktop\\DispalyBAhai\\JavaApplication2\\src\\son\\l'utilisateur existe déjà.wav"); // Replace with the actual path to your song file
...
//            JOptionPane.showMessageDialog(this, "Song is playing. Click OK to stop.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(erouruser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
