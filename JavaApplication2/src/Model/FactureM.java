...
public class FactureM {
  ...
  public   float	montant_a_paye;
   ...
   public String etat;
    ...
    public FactureM(int N_fact,String nom_prenom_forn, float montant_a_paye, float montant_verser, float montant_reste, String date_versement, String etat) {
       this.N_fact = N_fact;
